...
<body>
    <div class="navbar">
        ...
        <ul class="navbarItem">
            <li id="a"><a href="main.php">Home</a></li>
    ...
    <div class="section1" id="section1">
        <div class="form">
            ...
            <form action="proses.php" method="post">
                <div class="ktp" name="no_ktp">
                    ...
                    <input type="text" name="no_ktp" id="no_ktp" maxlength="15">
                </div>
                ...
                <div class="noTelp" name="no_hp">
                    ...
                    <input type="number" name="no_hp" id="no_hp" maxlength="15">
                </div>
                <div class="mobil" name="kd_mobil">
                    <label>Mobil</label><br>
                    <select name="kd_mobil" id="kd_mobil">
                        <option value="DD HCR51 V">Honda CR-V</option>
                        <option value="DD C12 RS">Honda Civic RS</option>
                        <option value="DD TA 987">Toyota Avanza</option>
                        <option value="DD TV 22">Toyota Vios</option>
                        <option value="DD DA 62">Daihatsu Ayla</option>
                    </select>
                </div>
        ...
        <div class="carList" id="section2" align="center">
            ...
            <div class="row1" align="center">
                <div class="car">
                    <img src="Assets/Image/hondaCr-v.jpeg" alt="" height="100px" width="150px">
                    <div class="carInfo">
                ...
                <div class="car">
                    <img src="Assets/Image/hondaCivic.jpeg" alt="" height="100px" width="150px">
                    <div class="carInfo">
            ...
            <div class="row2" align="center">
                <div class="car">
                    <img src="Assets/Image/avanza.jpg" alt="" height="100px" width="150px">
                    <div class="carInfo">
                ...
                <div class="car">
                    <img src="Assets/Image/vios.jpeg" alt="" height="100px" width="150px">
                    <div class="carInfo">
            ...
            <div class="row3" align="center">
                <div class="car">
                    <img src="Assets/Image/ayla.jpeg" alt="" height="100px" width="150px">
                    <div class="carInfo">
